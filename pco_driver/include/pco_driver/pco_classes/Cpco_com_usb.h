...
#include <pco_driver/pco_classes/pco_includes.h>
#include <pco_common/pco_classes/Cpco_com.h>
#include <pco_common/VersionNo.h>
#include <pco_driver/pco_classes/VersionNo.h>
...
*/
    ...
    /// \return transfer status. 1 or greater = done, 0 = not done
    ///
    DWORD transfer_msgwait();
    ///
...
protected:
    ...
    ///
    /// \brief Enable camera to PC handshake 
